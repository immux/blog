...
export type SitePageContextIntlMessages = {
  header_indexTitle?: Maybe<Scalars['String']>;
  header_blogTitle?: Maybe<Scalars['String']>;
  header_contactTitle?: Maybe<Scalars['String']>;
  hero_title?: Maybe<Scalars['String']>;
  hero_subTitle?: Maybe<Scalars['String']>;
  whyImmux_title?: Maybe<Scalars['String']>;
  whyImmux_featureImmutableTitle?: Maybe<Scalars['String']>;
  whyImmux_featureImmutableDesc?: Maybe<Scalars['String']>;
  whyImmux_features_immutable_title?: Maybe<Scalars['String']>;
  whyImmux_features_immutable_description?: Maybe<Scalars['String']>;
  whyImmux_features_usable_title?: Maybe<Scalars['String']>;
  whyImmux_features_usable_description?: Maybe<Scalars['String']>;
  whyImmux_features_auditable_title?: Maybe<Scalars['String']>;
  whyImmux_features_auditable_description?: Maybe<Scalars['String']>;
  whyImmux_features_managed_title?: Maybe<Scalars['String']>;
  whyImmux_features_managed_description?: Maybe<Scalars['String']>;
  subscription_subscribeToUs?: Maybe<Scalars['String']>;
  subscription_subscribeBtn?: Maybe<Scalars['String']>;
  footer_joinUs?: Maybe<Scalars['String']>;
};

export type SitePageContextIntlMessagesFilterInput = {
  header_indexTitle?: Maybe<StringQueryOperatorInput>;
  header_blogTitle?: Maybe<StringQueryOperatorInput>;
  header_contactTitle?: Maybe<StringQueryOperatorInput>;
  hero_title?: Maybe<StringQueryOperatorInput>;
  hero_subTitle?: Maybe<StringQueryOperatorInput>;
  whyImmux_title?: Maybe<StringQueryOperatorInput>;
  whyImmux_featureImmutableTitle?: Maybe<StringQueryOperatorInput>;
  whyImmux_featureImmutableDesc?: Maybe<StringQueryOperatorInput>;
  whyImmux_features_immutable_title?: Maybe<StringQueryOperatorInput>;
  whyImmux_features_immutable_description?: Maybe<StringQueryOperatorInput>;
  whyImmux_features_usable_title?: Maybe<StringQueryOperatorInput>;
  whyImmux_features_usable_description?: Maybe<StringQueryOperatorInput>;
  whyImmux_features_auditable_title?: Maybe<StringQueryOperatorInput>;
  whyImmux_features_auditable_description?: Maybe<StringQueryOperatorInput>;
  whyImmux_features_managed_title?: Maybe<StringQueryOperatorInput>;
  whyImmux_features_managed_description?: Maybe<StringQueryOperatorInput>;
  subscription_subscribeToUs?: Maybe<StringQueryOperatorInput>;
  subscription_subscribeBtn?: Maybe<StringQueryOperatorInput>;
  footer_joinUs?: Maybe<StringQueryOperatorInput>;
};
...
export type SitePageFieldsEnum = 
  ...
  | 'context___intl___messages___header_indexTitle'
  | 'context___intl___messages___header_blogTitle'
  | 'context___intl___messages___header_contactTitle'
  | 'context___intl___messages___hero_title'
  | 'context___intl___messages___hero_subTitle'
  | 'context___intl___messages___whyImmux_title'
  | 'context___intl___messages___whyImmux_featureImmutableTitle'
  | 'context___intl___messages___whyImmux_featureImmutableDesc'
  | 'context___intl___messages___whyImmux_features_immutable_title'
  | 'context___intl___messages___whyImmux_features_immutable_description'
  | 'context___intl___messages___whyImmux_features_usable_title'
  | 'context___intl___messages___whyImmux_features_usable_description'
  | 'context___intl___messages___whyImmux_features_auditable_title'
  | 'context___intl___messages___whyImmux_features_auditable_description'
  | 'context___intl___messages___whyImmux_features_managed_title'
  | 'context___intl___messages___whyImmux_features_managed_description'
  | 'context___intl___messages___subscription_subscribeToUs'
  | 'context___intl___messages___subscription_subscribeBtn'
  | 'context___intl___messages___footer_joinUs'
...
export type BlogQueryQuery = { site?: Maybe<{ meta?: Maybe<Pick<SiteSiteMetadata, 'title' | 'description' | 'siteUrl' | 'author' | 'adsense' | 'keywords'>> }>, remark: { posts: Array<{ post: (
...
export type ContactPageQueryQuery = { site?: Maybe<{ meta?: Maybe<Pick<SiteSiteMetadata, 'title' | 'description' | 'siteUrl' | 'author' | 'adsense' | 'keywords'>> }>, contact?: Maybe<{ childImageSharp?: Maybe<{ fixed?: Maybe<GatsbyImageSharpFixed_WithWebpFragment> }> }> };

export type IndexQueryQueryVariables = Exact<{ [key: string]: never; }>;


export type IndexQueryQuery = { site?: Maybe<{ meta?: Maybe<Pick<SiteSiteMetadata, 'title' | 'description' | 'siteUrl' | 'author' | 'adsense' | 'keywords'>> }>, remark: { posts: Array<{ post: (
        Pick<MarkdownRemark, 'html'>
        & { frontmatter?: Maybe<(
          Pick<MarkdownRemarkFrontmatter, 'layout' | 'title' | 'path' | 'category' | 'tags' | 'description' | 'date'>
          & { image?: Maybe<{ childImageSharp?: Maybe<{ fluid?: Maybe<GatsbyImageSharpFluidFragment> }> }> }
